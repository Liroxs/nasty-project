return {
    ...
    head: <>
        <meta property="og:title" content="NastyClxn - Rank" />

        <meta property="description" content="Site de rank de la NastyClxn." />
        <meta property="og:description" content="Site de rank de la NastyClxn." />
    </>,

    body: <>
        <nav>
            <p class="sitename" onclick="location.href='/'">NastyClxn</p>
            <p class="menu" onclick="location.href='/play'">Jouer</p>
            <p class="menu" onclick="location.href='/rank'">Classement</p>
            <p class="menu" onclick="location.href='/chat'">ChatBox</p>
            <p class="menu" onclick="location.href='/about'">About us</p>
            ...
            <li class="profile">
            <a href="/profile">
                <img src="https://ui-avatars.com/api/?background=1e1f30&color=fff&amp;size=10&amp;rounded=true&amp;length=1&amp;name=sp4r1ng" alt="Profile" class="profile-icon"/>
            </a>
        </li>
        </nav>
        <div class="grid">
